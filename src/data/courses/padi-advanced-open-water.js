import padi_advanced_open_water from "../../assets/padi-advanced-open-water.jpg";
...
export const padiAdvancedOpenWaterData = {
  ...
  seo: {
    ...
    description: "Perfecciona tus habilidades con el curso PADI Advanced Open Water de JustDiveCol. Explora el buceo profundo, la navegación subacuática y más."
  },
  header: {
    title: "PADI ADVANCED OPEN WATER",
    subtitle: "Lleva tus habilidades y aventuras al siguiente nivel.",
    imageUrl: padi_advanced_open_water,
  },
  description: {
  ...
  details: {
    ...
    items: [
      ...
      { label: "Prerrequisito", value: "PADI Open Water Diver" },
