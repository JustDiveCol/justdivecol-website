import padi_open_water_diver from "../../assets/padiOpenWater/padi-open-water.jpg";
import padi_open_water_pool from "../../assets/padiOpenWater/padi-open-water-pool.jpg";
import padi_open_water_pool_session from "../../assets/padiOpenWater/padi-open-water-pool-session.jpg";
...
export const padiOpenWaterDiverData = {
  ...
  seo: {
    ...
    description: "Conviértete en un buzo certificado con el curso PADI Open Water Diver de JustDiveCol. Aprende los fundamentos del buceo y obtén tu certificación para explorar el mundo submarino."
  },
  header: {
    title: "PADI OPEN WATER DIVER",
    subtitle: "Tu pasaporte para explorar el 70% del planeta.",
    imageUrl: padi_open_water_diver,
  },
  description: {
  ...
  whatIsIncluded: {
    ...
    items: [
      ...
      "Seguro de buceo DAN durante el curso",
    ],
  },
  gallery: {
    title: "Momentos del Curso",
    images: [
      padi_open_water_pool,
      padi_open_water_pool_session,
      "https://placehold.co/800x600/36598B/FFFFFF?text=Celebrando+Certificación",
      "https://placehold.co/800x600/36598B/FFFFFF?text=Bajo+el+Agua",
    ],
  },
  cta: {
