export const expedicionSantaMartaData = {
  ...
  seo: {
    title: "Certificación PADI Open Water en Santa Marta | Viaje de Buceo Tayrona",
    description: "Obtén tu licencia de buceo PADI Open Water en un viaje inolvidable a Santa Marta. Aprende en las aguas cristalinas del Parque Tayrona con JustDiveCol. ¡Paquete todo incluido!"
  },
  ...
  header: {
    ...
    imageUrl:
      "https://placehold.co/1920x800/36598B/FFFFFF?text=Tu+Primera+Inmersión",
  },
  ...
  details: {
    ...
    endDate: "2025-09-29",
    items: [
      { label: "Precio", value: "Desde COP 3.500.000" },
      {
        label: "Inmersiones",
  ...
  itinerary: {
    ...
    days: [
      ...
      {
        day: 2,
        title: "¡Al Mar! Primeras Inmersiones en Tayrona",
        description:
          "Después del desayuno, nos dirigimos al Parque Tayrona para realizar tus primeras dos inmersiones en aguas abiertas. Por la tarde, tendrás tiempo libre para relajarte antes de nuestra noche de trivia.",
      },
      {
        day: 3,
    ...
    note: "Nota Importante: Para asegurar que tengas tiempo suficiente y cumplas con las recomendaciones de no volar después de bucear, te recomendamos comprar tu vuelo de regreso para después del mediodía del último día.",
  },
  ...
  gallery: {
    ...
    images: [
      "https://placehold.co/800x600/36598B/FFFFFF?text=Paisaje+Tayrona",
      "https://placehold.co/800x600/36598B/FFFFFF?text=Vida+Marina",
      "https://placehold.co/800x600/36598B/FFFFFF?text=Buzos+Explorando",
      "https://placehold.co/800x600/36598B/FFFFFF?text=Atardecer+en+la+Playa",
    ],
  },
